...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-secondary">Sender Information</b>
					<dl>
						<dt>Name:</dt>
				...
				<div class="callout callout-info">
					<b class="border-bottom border-secondary">Recipient Information</b>
					<dl>
						<dt>Name:</dt>
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-secondary">Parcel Details</b>
						<div class="row">
							<div class="col-sm-6">
								<dl>
									<dt>Wight:</dt>
							...
							<div class="col-sm-6">
								<dl>
									...
									<dt>Type:</dt>
									<dd><?php echo $type == 1 ? "<span class='badge badge-secondary'>Deliver to Recipient</span>":"<span class='badge badge-info'>Pickup</span>" ?></dd>
								</dl>	
							</div>
						</div>
					<dl>
